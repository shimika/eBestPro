BEGIN_FUNCTION_MAP
    .Func,선옵정상주문(t5511),t5511,base21=SONBT001,headtype=B;
    BEGIN_DATA_MAP
    t5511InBlock,기본입력,input;
    begin
        ...
        선물옵션주문유형코드     ,offergb      		,offergb      	   ,char    ,2	    ;
        선물옵션호가유형코드     ,hogagb       		,hogagb       	   ,char    ,2	    ;
        선물옵션거래유형코드     ,tradegb      		,tradegb      	   ,char    ,2	    ;
